const ru = {
  ...
  settings: {
    ...
    notifications: {
      ...
      aiCreditsAlertDesc: 'Получайте уведомления, когда баланс AI-кредитов достигает или опускается ниже установленного значения',
      aiCreditsThreshold: 'Порог уведомления об AI-кредитах',
      aiCreditsThresholdDesc: 'Количество кредитов, при достижении которого срабатывает уведомление',
