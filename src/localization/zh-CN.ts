const zhCn = {
  ...
  traffic: {
    title: '流量监控',
    description: '查看模型调用和应用活动，快速找到出错的请求。',
    records: '{{count}} 条记录',
    'on-disk': '磁盘占用 {{size}}',
    dropped: '已丢弃 {{count}} 条',
    model: '模型请求',
    ...
    'search-metadata': '搜索元数据：请求 ID、模型、URL、协议',
    'date-from': '开始',
    'date-to': '结束',
    account: '反代账号',
    'all-accounts': '全部账号',
    'model-family': '模型系列',
    'all-model-families': '全部模型系列',
    'physical-model': '实际使用的模型',
    'output-type': '输出类型',
    'all-output-types': '全部输出',
    'text-output': '文本',
    'image-output': '图片',
    'mixed-output': '文本 + 图片',
    'no-visible-output': '无可见输出',
    unknown: '未知',
    ...
    unfinished: '未完成',
    'no-status': '无状态码',
    'include-current-credential': '复制 cURL 时包含当前代理密钥',
    'credential-warning':
      '复制后的命令会把当前代理密钥暴露给剪贴板及粘贴位置；更改筛选或离开本页后开关重置。',
    'current-credential': '当前密钥',
    'copy-request-curl': '复制请求为 cURL',
    'copy-upstream-curl': '复制上游尝试为脱敏 cURL',
    'curl-copied': '已将 cURL 命令复制到剪贴板。',
    'curl-copy-failed': '复制 cURL 命令失败。',
    'new-records': '{{count}} 条新记录',
    refresh: '刷新',
    'confirm-clear': '确认清空',
    'clear-category': '清空当前分类',
    total: '共 {{count}} 条 · 第 {{page}} 页',
    'loading-records': '正在加载记录…',
    'no-records': '当前分类暂无记录。',
    'detail-title': '流量详情',
    'loading-detail': '正在加载流量详情…',
    ...
    request: '请求',
    response: '响应',
    'select-body': '请选择请求或响应正文。',
    concise: '精简',
    full: '完整',
    'view-mode-help': '查看视图模式说明',
    'concise-help': '精简仅保留常见的 JSON 顶层字段，不缩短嵌套内容。',
    'full-help': '完整显示已加载内容的全部字段；非 JSON 或不完整内容下，两种模式可能相同。',
    'search-body': '搜索当前正文',
    'copy-loaded': '复制已加载内容',
    'view-all-body': '查看全部',
    'load-more': '加载更多',
    'load-next-window': '下一段',
    'save-full': '保存完整正文',
    matches: '{{count}} 个匹配项',
    'first-100': '前 100 项',
    'parse-error': '解析错误位置：{{offset}}',
    partial: '部分结果',
    'session-key': '会话标识',
    'select-session': '选择会话后查看保存的思考内容。',
    'no-sessions': '暂无思考记录。',
    'delete-session': '删除会话记录',
    turns: '{{count}} 轮',
    offset: '偏移 {{offset}}',
    'unknown-model': '未知模型',
    'thought-oversized': '思考内容超过 64 MiB，未保存完整正文。SHA-256：{{hash}}',
    time: '时间',
    operation: '操作',
    'operation-url': '操作 / URL',
    result: '结果',
    duration: '耗时',
    status: '状态码',
    endpoint: '端点',
    protocol: '协议',
    'repair-databases': '修复数据库',
    'open-monitor': '打开流量监控',
  },
  editionSelection: {
  ...
  proxy: {
    ...
    config: {
      ...
      'global-system-prompt-title': '全局系统提示词',
      'global-system-prompt-description': '在每个代理请求中、客户端系统指令之前注入此提示词。',
      'global-system-prompt-placeholder':
        '输入全局系统提示词...\n例如：请使用简体中文回复，并简洁说明代码变更。',
      'global-system-prompt-character-count': '{{count}} 个字符',
      'global-system-prompt-long-warning':
        '提示词超过 2,000 个字符时，可能显著压缩可用上下文窗口。',
      local_access: '局域网访问:',
      select_ip: '选择 IP',
    ...
    persistence: {
      title: '请求记录与会话思考',
      description: '在本机保存请求和会话记录，方便排查问题。',
      'audit-title': '流量审计',
      'audit-description': '在独立 SQLite 数据库中保存已脱敏的请求、响应和每次上游尝试。',
      rows: '{{count}} 条请求',
      queue: '{{count}} 条待写入',
      dropped: '已有 {{count}} 条审计写入被丢弃（{{reason}}），模型请求未被中断。',
      'disk-gib': '磁盘上限（GiB）',
      'body-hours': '正文保留（小时）',
      'summary-days': '摘要保留（天）',
      'max-rows': '最大记录数',
      'no-audit': '暂无流量记录。',
      'audit-metadata': '请求与上游尝试元数据',
      'audit-body-missing': '审计正文已不存在。',
      'audit-body-expired': '正文已过期，元数据仍然保留。',
      partial: '部分保存',
      'logical-size': '逻辑大小',
      'parse-error-offset': '解析错误位置',
      loading: '正在加载…',
      'copy-progress': '正在准备完整复制：{{value}}%',
      'previous-page': '上一页',
      'next-page': '下一页',
      'copy-full': '复制完整正文',
      'confirm-copy-full': '确认复制 {{size}}',
      'clear-audit': '清空流量审计',
      'repair-audit': '修复审计数据库',
      'thought-title': '会话思考记录',
      'thought-description': '保存对话中的思考内容，供后续对话继续使用。',
      sessions: '{{count}} 个会话',
      'hard-limit': '硬上限：每会话 200 turns / 64 MiB',
      'retention-days': '保留天数',
      'max-sessions': '最大会话数',
      oversized: '正文超过 64 MiB，未完整保存',
      'no-thought-body': '没有保存的思考内容。',
      signature: '签名',
      'copy-signature': '复制签名',
      'no-thought': '暂无思考记录。',
      'clear-thought': '清空思考记录',
      'repair-thought': '修复思考记录',
      'confirm-clear': '确认清空',
      'confirm-repair': '确认修复',
    },
  },
